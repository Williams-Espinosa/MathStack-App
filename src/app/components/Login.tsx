      ...
      <div className="flex-1 flex flex-col">
        <div className="bg-gradient-to-br from-primary to-blue-700 py-10 px-8 rounded-b-[40px] shadow-xl">
          ...
          <h1 className="text-3xl font-bold text-white text-center mb-2">
            {step === 'otp' ? 'Verificación' : '¡Bienvenido a MathStack!'}
          </h1>
        </div>
            ...
            {step === 'credentials' ? (
              <>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-background text-muted-foreground">o inicia sesión con tu correo</span>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center justify-center space-y-8">
                <p className="text-center text-muted-foreground">
                  Ingresa el código de 4 dígitos que enviamos a <strong className="text-foreground">{email}</strong>
                </p>
                <form onSubmit={handleVerifyOtp} className="w-full flex flex-col items-center gap-6">
                  ...
                  <button
                    ...
                    className="text-muted-foreground text-sm hover:text-foreground flex items-center gap-2"
                  >
